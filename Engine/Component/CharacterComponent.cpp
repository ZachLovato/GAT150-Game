...
namespace wrap
{
	...
	std::unique_ptr<GameObject> CharacterComponent::Clone()
	{
	...
	void CharacterComponent::OnCollisionEnter(Actor* other)
	{
	}

	void CharacterComponent::OnCollisionExit(Actor* other)
	{
	}

	void CharacterComponent::OnNotify(const Event& event)
	{
	}
